#!/bin/ksh
# This script was generated Fri Nov 21 13:18:57 2025 by:
#
...
#	/home/install/FOUNDRY/analog/45nm_rev/qrc/best -newlvs \
#	/home/vlsi/Desktop/PLL_NEW/lvs1.xcn -assura_run_dir \
#	/home/vlsi/Desktop/PLL_NEW -assura_run_name lvs1 -rcxdir \
#	/home/vlsi/Desktop/PLL_NEW/lvs1 -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir /home/vlsi/Desktop/PLL_NEW/lvs1/rcx_temp \
...
#	/home/vlsi/Desktop/PLL_NEW/lvs1/extview.tmp -net_name_space layout \
...
#	-cap_ground Vdd -cap_extract_mode decoupled -cap_coupling_factor 1.0 \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/vlsi/Desktop/PLL_NEW/lvs1/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/vlsi/Desktop/PLL_NEW/lvs1
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/vlsi/Desktop/PLL_NEW/lvs1/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/vlsi/Desktop/PLL_NEW/lvs1/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/vlsi/Desktop/PLL_NEW/lvs1
...
/home/vlsi/Desktop/PLL_NEW/lvs1.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/vlsi/Desktop/PLL_NEW lvs1 -unit meters -mFactorR -- -V1 -H \
	satfile -r /home/vlsi/Desktop/PLL_NEW/lvs1.xcn -df2 -xgl
...
CAP_GROUND=`findCapGround -g Vdd NET`
...
mergevia -V -tech /home/install/FOUNDRY/analog/45nm_rev/qrc/best -cnt \
...
mergevia -V -i -tech /home/install/FOUNDRY/analog/45nm_rev/qrc/best -cnt \
...
rex -V -m -pd -I'#' -tech /home/install/FOUNDRY/analog/45nm_rev/qrc/best -map \
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -ignore_cf_table -scf sip.cmd -cgnd \
	...
	/home/install/FOUNDRY/analog/45nm_rev/qrc/best/qrcTechFile -f FOX \
	...
	/home/install/FOUNDRY/analog/45nm_rev/qrc/best/qrcTechFile - - NET - \
	capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/install/FOUNDRY/analog/45nm_rev/qrc/best -d1 -e \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	/home/vlsi/Desktop/PLL_NEW/lvs1/extview.tmp
