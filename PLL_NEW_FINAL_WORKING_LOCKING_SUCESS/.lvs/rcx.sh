#!/bin/ksh
# This script was generated Thu Nov  6 15:01:14 2025 by:
#
...
#	/home/install/FOUNDRY/analog/45nm/qrc/typical -newlvs \
#	/home/vlsi/Desktop/PLL_NEW/lvs.xcn -assura_run_dir \
#	/home/vlsi/Desktop/PLL_NEW -assura_run_name lvs -rcxdir \
#	/home/vlsi/Desktop/PLL_NEW/lvs -type full -temperature 25.0 -tempdir \
#	/home/vlsi/Desktop/PLL_NEW/lvs/rcx_temp -sub_node_char # -res_models \
#	no -parasitic_res_width -parasitic_res_models comment \
#	-parasitic_cap_models comment -output_net_name_space schematic \
#	-output_hierarchy_delimiter / -output \
#	/home/vlsi/Desktop/PLL_NEW/lvs.sp -net_name_space layout -minR 0.001 \
...
#	-fracture_length_units MICRONS -extract both -device_finger_delimiter \
#	@ -cap_models no -cap_ground Vss -cap_extract_mode decoupled \
#	-cap_coupling_factor 1.0 -array_vias_spacing auto -corner rcx_typical \
#	-xref \
#	/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gnx,/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/home/vlsi/Desktop/PLL_NEW/lvs.sp
...
##RC_FREQUENCY=
##RCXDIR=/home/vlsi/Desktop/PLL_NEW/lvs
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/vlsi/Desktop/PLL_NEW/lvs/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gnx,/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gdx
##XY_COORDINATES=
##=======================================================
...
TEMPDIR=`setTempDir /home/vlsi/Desktop/PLL_NEW/lvs/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/vlsi/Desktop/PLL_NEW/lvs
...
/home/vlsi/Desktop/PLL_NEW/lvs.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/vlsi/Desktop/PLL_NEW lvs -unit meters -mFactorR -- -V1 -H \
	satfile -r /home/vlsi/Desktop/PLL_NEW/lvs.xcn -xgl
...
flattenLayers -m metal1_conn poly_conn ndiff_conn pdiff_conn nwell_conn \
	...
	cont_pdiff cont_ndiff _nmos1v_MOS_2_orig _pmos1v_MOS_10_orig
endFlattenInputs
...
mergevia -V -tech /home/install/FOUNDRY/analog/45nm/qrc/typical -cnt \
...
mergevia -V -i -tech /home/install/FOUNDRY/analog/45nm/qrc/typical -cnt \
...
rex -V -m -pd -I'#' -tech /home/install/FOUNDRY/analog/45nm/qrc/typical -map \
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -ignore_cf_table -scf sip.cmd -cgnd \
	...
	/home/install/FOUNDRY/analog/45nm/qrc/typical/qrcTechFile -f FOX \
	...
	/home/install/FOUNDRY/analog/45nm/qrc/typical/qrcTechFile - - NET - \
	capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/install/FOUNDRY/analog/45nm/qrc/typical -d1 -mfactorR infinite \
	-decoupled -danglingR -minR 0.001 -rPvia \
	rcont_poly.res,rcont_pdiff_metal1_conn_pdiff_conn.res,rcont_ndiff_metal1_conn_ndiff_conn.res \
	-rP np_rpoly_conn.res,np_rmetal1_conn.res,mwires.res -cap capfile \
	L1T0 _nmos1v_MOS_2.transr _pmos1v_MOS_10.transr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -dxref \
	/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gdx -nxref \
	/home/vlsi/Desktop/PLL_NEW/lvs/lvs.gnx -sc caps2dversion -mm capfile \
	-rPmw res.mod np_rpoly_conn.res np_rmetal1_conn.res rcont_poly.res \
	rcont_pdiff_metal1_conn_pdiff_conn.res \
	rcont_ndiff_metal1_conn_ndiff_conn.res -rPmw mwires.mod mwires.res \
	-ta lvsmos.mod,_nmos1v_MOS_2.net _nmos1v_MOS_2.transr -ta \
	lvsmos.mod,_pmos1v_MOS_10.net _pmos1v_MOS_10.transr - NET - \
	/home/vlsi/Desktop/PLL_NEW/lvs.sp
